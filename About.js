let element3=document.getElementById('fullbody')
const About=()=> {
    console.log('hello')
    element3.innerHTML=`<div class="content-one">
            <img src = "dj1.jpg"
    ...
    I have fetched two apis here .Sometimes, the video you are trying to play may not play sorry for that as because they are corrupted .
<br><br><br>
    ~Web Developer
    </div>
